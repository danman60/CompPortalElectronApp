...
This project is indexed by GitNexus as **CompSyncElectronApp** (538 symbols, 1550 relationships, 41 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
