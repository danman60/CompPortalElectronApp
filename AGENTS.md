...
This project is indexed by GitNexus as **CompSyncElectronApp** (836 symbols, 2323 relationships, 63 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
